...
@NgModule({
  declarations: [AttJobFilterComponent, AttJobFilterSearchInputComponent,
                 ...
                 AttJobFilterApiOptionsCriteriaComponent, AttJobFilterStringCriteriaComponent, AttJobFilterDateCriteriaComponent],
  imports: [
    CommonModule
  ],
  entryComponents: [AttJobFilterOptionsCriteriaComponent, AttJobFilterPeriodCriteriaComponent, AttJobFilterDateCriteriaComponent],
